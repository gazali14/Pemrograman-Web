...
<body>
    ...
    if (count($rows) > 0) {
        ...
        foreach ($rows as $row) {
            ...
            echo "<a href='php11G.php?slot=" . $row["slot"] . "'><img src='img/edit.png' style='width:30px;height:30px;' alt='Edit' title='Edit'></a>";
            echo "<a href='php11H.php?slot=" . $row["slot"] . "'><img src='img/remove.png' style='width:30px;height:30px;' alt='Delete' title='Delete'></a>";
            echo "</td>";
            echo "</tr>";
        }        
        echo "</table>";
    ...
    ?>
    <!-- Tambah Data button -->
    <a href="php11E.php" class="btn-tambah">Tambah Data</a>
